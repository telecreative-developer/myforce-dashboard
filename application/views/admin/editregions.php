                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-12">
                                    <h2 class="title">Edit Regions</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-12">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="<?php echo base_url();?>regions">Regions</li></a>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Edit Your Regions</small></h5>
                                                </div>
                                            </div>
                                            <div class="panel-body">
                                            <?php foreach($regions as $result){?>
                                                <form method="POST" action="<?php echo base_url()?>updateregions/<?php echo $result->id_region;?>" class="form-horizontal">
                                                    <div class="form-group">
                                                      <label for="text1" class="col-sm-2 control-label">Title</label>
                                                      <div class="col-sm-10">
                                                        <input type="text" name="title" class="form-control" id="title" value="<?php echo $result->region;?>" placeholder="Input type text">
                                                      </div>
                                                    </div>
                                                    <div class="form-group">
