                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Edit Your Teams</small></h5>
                                                </div>
                                            </div>
                                            <div class="panel-body">
                                            <?php foreach($teams as $result){?>
                                                <form method="POST" action="<?php echo base_url()?>updateTeams/<?php echo $result->id_team_update;?>" class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_branch" class="form-control" required="ON">
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $forteams->id_branch;?>"><?php echo $forteams->branch;?></option>
                                                            <?php   
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_pipeline" class="form-control" required="ON">
                                                            ...
                                                            <?php 
                                                            foreach($pipelines as $forteams){
                                                            ?>
                                                            <option value="<?php echo $forteams->id_pipeline;?>"><?php echo $forteams->pipeline;?></option>
                                                            <?php   
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_customer" class="form-control" required="ON">
                                                            ...
                                                            <?php 
                                                            foreach($customers as $forteams){
                                                            ?>
                                                            <option value="<?php echo $forteams->id_customer;?>"><?php echo $forteams->name;?></option>
                                                            <?php   
                                                            }
                                                            ?>
                                                        </select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="id_sales" class="form-control" required="ON">
                                                            ...
                                                            <?php 
                                                            foreach($sales as $forteams){
                                                            ?>
                                                            <option value="<?php echo $forteams->id;?>"><?php echo $forteams->username;?></option>
                                                            <?php   
                                                            }
                                                            ?>
                                                        </select>
