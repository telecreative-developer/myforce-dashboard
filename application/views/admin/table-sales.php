                                            ...
                                            <div class="panel-body p-20">
                                                <table id="example" class="display table-responsive table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $no;?></td>
                                                            <td><img src="<?php echo $result->avatar;?>" width="100%"/></td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a onclick="javascript:return confirm('Delete ?')" href="<?php echo base_url();?>deleteEvents/<?php echo $result->id;?>"><button type="button" class="btn btn-danger btn-xs btn-labeled"><i class="fa fa-remove"></i></button></a>
                                                            </td>
                                                        </tr>
                                                        <?php 
                                                            $no++;
